...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("../task24/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "../task24/test.png");
        ...
        return m_pMesh->LoadMesh("../task24/phoenix_ugv.md2");
    }
