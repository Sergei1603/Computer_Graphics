...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("../task26/box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "../task26/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "../task26/normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "../task26/normal_up.jpg");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, true, "Tutorial 26")) {
        return 1;
    }
